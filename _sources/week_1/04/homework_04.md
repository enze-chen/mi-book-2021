...
1. We recommend revisiting [the paper by Petousis et al.] on the dielectric constants dataset. 
...
1. (optional) [The review article](https://drive.google.com/file/d/1cLXY2B3ZAPKHfLrwlsyCVMVfVQzDIEac/view?usp=sharing) by J. Robertson on "High dielectric constant oxides" {cite}`robertson_2004`.
    - This is a pretty hefty article that goes deep into bonding, interfaces, defects, band structures... so please only skim _up to and including Section 2.4_.
    This will help set the stage for tomorrow's discussion of research and materials selection/screening.
